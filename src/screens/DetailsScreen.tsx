...
const DetailsScreen = () => {
  ...
  const route = useRoute<RootStackScreenProps<'DetailsScreen'>['route']>();
  ...
  return (
    <View style={{ flex: 1, position: 'relative' }}>
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
        ...
        ></View>
        <View style={{ zIndex: 1 }}>
          <Animated.View style={style.detailsContainer} sharedTransitionTag={`${pet.id}-name`}>
            {/*
            ...
            >
              <View>
                ...
                <Text style={style.comment}>
                  My job requires moving to another country. I don't have the opputurnity to take
                  the cat with me. I am looking for good people who will shelter my Lily.
                </Text>
              </View>
            </View>
          </View>
